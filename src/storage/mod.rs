...
use crate::domain::{
    DomainError, EventDraft, EventRecord, GlobalPosition, SessionEvent, SessionOwner, SessionState,
    SessionStatus, StreamVersion, EVENT_SCHEMA_VERSION, REDUCER_SCHEMA_VERSION,
    SESSION_CREATED_SCHEMA_VERSION, STATE_SCHEMA_VERSION,
};
...
impl StorePort for SqliteEventStore {
