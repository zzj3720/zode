...
function defaultEnv() {
  ...
  for (const key of [
    'ZODE_RUN_LIVE_PROVIDER_E2E', 'ZODE_E2E_LIVE_PROVIDER_BASE_URL',
    'ZODE_E2E_LIVE_PROVIDER_API_KEY', 'ZODE_E2E_LIVE_PROVIDER_MODEL',
    'ZODE_E2E_LIVE_PROVIDER_ID', 'ZODE_RELEASE_LIVE_PROVIDER_API_KEY',
    'ZODE_RELEASE_PROVIDER_API_KEY', 'ZODE_RELEASE_SECRET_VALUES_JSON',
    'OPENCODE_GO_API_KEY', 'OPENCODE_API_KEY', 'DEEPSEEK_API_KEY', 'OPENAI_API_KEY', 'OPENROUTER_API_KEY',
